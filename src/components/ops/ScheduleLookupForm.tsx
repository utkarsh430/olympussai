...
export function ScheduleLookupForm({
  ...
  return (
    <div className="rounded-md border border-ops-line p-4">
      ...
      {formError && (
        <p id={errorId} role="alert" className="mt-3 text-sm text-alert-crimson">
          {formError}
        </p>
      )}
        ...
        <div className="mt-4">
          ...
          */}
          {result.source === 'unavailable' ? (
            <p role="alert" data-source="unavailable" className="mb-3 text-sm text-ops-danger">
            ...
            (result.source === 'fixture' || result.stale) && (
              <p role="status" data-source={result.source} className="mb-3 text-sm text-ops-warn">
