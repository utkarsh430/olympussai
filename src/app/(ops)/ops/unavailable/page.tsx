...
export default async function OpsUnavailablePage({
  ...
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-center gap-4 px-6 text-center">
      <p className="ops-eyebrow">Olympuss AI</p>
      <h1 className="text-2xl font-semibold text-ops-ink">
        Temporarily unavailable
      </h1>
      <p className="max-w-md text-sm leading-relaxed text-ops-muted">
      ...
      <p className="max-w-md text-[12px] leading-relaxed text-ops-faint">
