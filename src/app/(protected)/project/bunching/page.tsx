 ...
 * (void background, Orbitron display type, tabular numerals) is applied here
 * instead, so the page still reads as part of the same product.
 */
...
export default async function BunchingPage() {
  ...
  return (
    <div className="bg-void font-display text-[#d6ecf7] [font-feature-settings:'tnum'_1] antialiased">
      <a
        href="#bunching-main"
